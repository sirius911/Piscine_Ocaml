...
(*                                                +#+#+#+#+#+   +#+           *)
(*   Created: 2023/07/23 13:57:33 by clorin            #+#    #+#             *)
(*   Updated: 2023/07/23 14:12:21 by clorin           ###   ########.fr       *)
(*                                                                            *)
(* ************************************************************************** *)
...
let life (s : string) : unit =
  print_endline "*** NUCLEOTIDE ***";
  let nucleotide1 = generate_nucleotide 'A' in
  print_nucleobase nucleotide1;

  print_endline "\n*** HELIX ***";
  let h1 = generate_helix 1000 in
  ...
  print_endline (string_of_protein prtn)
