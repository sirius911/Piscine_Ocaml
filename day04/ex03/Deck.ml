...
(*                                                +#+#+#+#+#+   +#+           *)
(*   Created: 2023/09/04 09:25:59 by clorin            #+#    #+#             *)
(*   Updated: 2023/09/04 14:07:57 by clorin           ###   ########.fr       *)
(*                                                                            *)
(* ************************************************************************** *)
...
let newDeck () = 
  ...
  let shuffled_deck deck = 
    List.sort (fun _ _ -> Random.int 3 - 1) deck in
    shuffled_deck Card.all
...
let isEmpty deck = match deck with
  | [] -> true
  | _  -> false